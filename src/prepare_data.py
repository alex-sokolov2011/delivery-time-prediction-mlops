...
def prepare_data(root_dir, start_date, end_date, dataset_dir=None):
    ...
    locations_df = pd.read_csv(os.path.join(dataset_dir, 'olist_geolocation_dataset.csv'))
    orders_items_dataset = pd.read_csv(os.path.join(dataset_dir, 'olist_order_items_dataset.csv'))
...
if __name__ == '__main__':
    ...
    result_csv_path = prepare_data(config['root_data_dir'], date_start, date_end, dataset_dir=dataset_dir)
