        ...
        .merge(
            locations_df[
                ...
                columns={
                    ...
                    'geolocation_lat': 'dest_lat',
                    'geolocation_lng': 'dest_lng',
                }
            ),
        ...
        .merge(
            locations_df[
                ...
                columns={
                    ...
                    'geolocation_lat': 'start_lat',
                    'geolocation_lng': 'start_lng',
                }
            ),
            on='seller_zip_code_prefix',
        )
    )
    delivery_df['delivery_distance_km'] = delivery_df.apply(
        lambda row: haversine(
            row['start_lat'], row['start_lng'], row['dest_lat'], row['dest_lng']
        ),
        axis=1,
    )
